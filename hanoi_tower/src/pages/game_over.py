...
class Game_over:
    ...
    def draw_game_results(self) -> None:
        ...
        self.game_object.screen.blit(line, (self.game_object.screen_size[0]/2 - font_size[0]/2, self.y_pos - 10))
        
        font_size = pygame.font.Font.size(fonts.montserrat_size_16.value, f"Moves: {self.game_data[1]}")
        line = fonts.montserrat_size_16.value.render(f"Moves: {self.game_data[1]}", True, color.white.value)
        self.game_object.screen.blit(line, (self.game_object.screen_size[0]/2 - font_size[0]/2, self.y_pos + 30))

        font_size = pygame.font.Font.size(fonts.montserrat_size_16.value, f"Timer: {self.game_data[2]}")
        line = fonts.montserrat_size_16.value.render(f"Timer: {self.game_data[2]}", True, color.white.value)
        self.game_object.screen.blit(line, (self.game_object.screen_size[0]/2 - font_size[0]/2, self.y_pos + 60))
