...
class Game_loop:
    ...
    player_1: tuple             # to store the configuration of the player 1
    player_2: tuple             # to store the configuration of the player 2
    ...
    def initializing_game_mode(self, game_mode: str) -> None:
        if game_mode == "human_player": 
             self.player_1 = (HumanPlayer(1), 1)
             self.player_2 = (HumanPlayer(1), 2)
        elif game_mode == "random_player":
            self.player_1 = (HumanPlayer(1), 1)
            self.player_2 = (RandomPlayer(1), 2)
        elif game_mode == "ai_player":
            self.player_1 = (HumanPlayer(1), 1)
            self.player_2 = (AIPlayer(1), 2)
        else:
            self.player_1 = (AIPlayer(1), 1)
            self.player_2 = (AIPlayer(1), 2)
    ...
    def falling_down_efect(self, play_position: int) -> int:
        ...
        self.falling_obj = Falling_object(self.screen, self.start_position, self.end_position, 1, self.row_radius)
    ...
    def update_board(self, player_move: int, player: int) -> None:
        ...
        self.board[line_index][player_move] = player

    def control_who_is_playing(self) -> None:
